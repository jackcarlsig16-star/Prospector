...
export default function App() {
  ...
  return(
    <div style={{ display:"flex", background:C.bg, minHeight:"100vh", width:"100%" }}>
      ...
      {dealSummaryAccId&&<DealSummaryModal accId={dealSummaryAccId} accounts={accounts} onClose={()=>setDealSummaryAccId(null)}/>}

...
export default function PersonasSection({ acc, business, projects=[], campaigns=[], onUpdate }) {
  ...
  return(
    <div style={{ marginTop:12, borderLeft:"2px solid #0f6e56", paddingLeft:12, paddingTop:8, paddingBottom:8 }}>
      {emailModal&&<EmailModal account={acc} business={business} projects={projects} campaigns={campaigns} persona={emailModal} onClose={()=>setEmailModal(null)} onSaveEmail={saveEmail}/>}

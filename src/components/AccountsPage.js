...
function AccountsPage({ accounts, onSave, onAddAccount, onRemoveAccount, perms={}, frontier=[], onAssignToBDR, onUnassignFromFrontier, onFlagRemoval, jumpToId=null, onJumped, onNav, onCreateTask, onUpdateTask, tasks=[], activeRole="AE", activeUser={}, teamUsers=[], sfdcOpps=[], onSyncSfdc, sfdcSyncing=false, onSfdcOppsImported, managerSelectedAeId=null, business=null, onInfluencerUpdated, projects=[], campaigns=[], accountListMap={}, onAccountLinkedToProject,
